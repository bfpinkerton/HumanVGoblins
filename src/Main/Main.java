...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Humans vs Goblins."
                    + "In this land, You are a Human & you are at war." + goblinUtf + humanUtf);
        System.out.println("What is your name?" + humanUtf);
        String setName = nameInput.nextLine().trim();

        Human h1 = new Human(setName + humanUtf);
        ...
        while (playAgain) {
            ...
            if (h1.inventory.contains("Sword")){
                h1.setAttack(10);
            }

            if (h1.inventory.contains("Gun")){
                h1.setAttack(20);
            }

            if (h1.inventory.contains("Pepper Spray")) {
                h1.setAttack(15);
            }

            if (h1.inventory.contains("Grenade")){
                h1.setAttack(25);
            }

            int randNum = RandomRan.generator(0, (gobNames.size() - 1));
            ...
            int gob1 = 5;
            int gob2 = RandomRan.generator(0, 5);
            int hum1 = 0;
            int hum2 = RandomRan.generator(0, 5);
